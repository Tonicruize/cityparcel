...
<body>
	...
	<div class="container">
		...
		<div class="logo-block-wrapper">
			<a class="logo"
				href="index-2.html"><img src="uploads/logo.png" alt="DEPRIXA PRO"  width="171" height="44"/></a>
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu">
                ...
                <li><a href="tracking.php" class="sub-menu-item"><i class="mdi mdi-package-variant-closed"></i> Tracking</a></li>

                <li><a href="services-freight.html" class="sub-menu-item">Service</a></li>
<li><div class="buy-button">
			<a href="sign-up.php" class="btn btn-light-outline rounded"><i class="mdi mdi-account-alert ml-3 icons"></i>
				Sign up</a>
		</div></li>
